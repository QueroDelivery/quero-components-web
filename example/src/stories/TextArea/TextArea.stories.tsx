...
import { TextArea, TextAreaProps } from '@quero-delivery/quero-components-web';
...
export default {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'TextArea padronizado do HTML, recebendo todas as suas propriedades',
      },
    },
  },
  argTypes: {
    ...
    lengthInfo: {
      control: 'boolean',
      description:
        'Deseja ter a informação de quantidade de quantos caracteres estão dentro do TextArea?',
      table: {
        type: {
