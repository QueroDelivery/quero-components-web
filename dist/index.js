...
var TextFirst = styled__default.span(_templateObject2(), function (props) {
  if (props.colorText) {
    return props.colorText;
  }
...
var TextEnd = styled__default.span(_templateObject3(), function (props) {
  if (props.colorText) {
    return props.colorText;
  }
...
var Notification = styled__default.button(_templateObject4(), colors.brand10, colors.brand30, colors.brandTransparent2, colors.brand30);
var Icon = styled__default.div(_templateObject5());
var Amount = styled__default.div(_templateObject6(), colors.brand30, colors.brand10);
...
var Load = styled__default.div(_templateObject2$1(), function (props) {
  if (props.size) {
...
var ButtonMain = function ButtonMain(_ref) {
  ...
  if (notification) {
    return React$2__default.createElement(Notification, Object.assign({}, rest), loading ? React$2__default.createElement(Loader, {
      size: "tiny"
    }) : children ? children : React$2__default.createElement("div", {
      style: {
        display: 'flex',
    ...
    return React$2__default.createElement(Button, Object.assign({}, rest, {
      ...
      tertiary: tertiary,
      size: size
    }), loading ? React$2__default.createElement(Loader, {
      size: "tiny"
    }) : children ? children : React$2__default.createElement("div", null, React$2__default.createElement(TextFirst, {
      ...
      tertiary: tertiary,
      size: size
    }, textEnd), icon && React$2__default.createElement(React$2__default.Fragment, null, React$2__default.createElement(FontAwesomeIcon, {
      icon: icon,
...
var Background = styled__default.div(_templateObject$2(), function (props) {
  return props.open ? styled.css(_templateObject2$2()) : styled.css(_templateObject3$1());
});
var Dialog = styled__default.div(_templateObject4$1(), function (props) {
  return props.open ? styled.css(_templateObject5$1(), colors.white) : styled.css(_templateObject6$1());
});
...
var Container$1 = styled__default.div(_templateObject$3(), function (props) {
  ...
  return props.isFieldActive ? styled.css(_templateObject2$3(), colors.brand10) : styled.css(_templateObject3$2(), colors.gray20);
}, function (props) {
  if (props.icon && !props.action) {
    if (props.iconPosition === 'right') {
      return '15px';
  ...
  return props.isFieldActive ? styled.css(_templateObject4$2(), function (props) {
    if ((props.requiredText || props.errorMessage) && props.errorColor) {
      return props.errorColor;
    }
    ...
    return colors.brand10;
  }) : styled.css(_templateObject5$2(), function (props) {
    if ((props.requiredText || props.errorMessage) && props.errorColor) {
      return props.errorColor;
    }
...
var LabelError = styled__default.span(_templateObject6$2(), function (props) {
  if (props.errorColor) {
    return props.errorColor;
  }
...
var InputLine = function InputLine(_ref) {
  ...
  return React$2__default.createElement("div", {
    ...
    style: labelStyle
  }, React$2__default.createElement("span", null, label))), errorMessage ? React$2__default.createElement(LabelError, null, errorMessage) : null);
};
...
var InputLineForm = function InputLineForm(_ref) {
  ...
  }, React$2__default.createElement("span", null, rest.label))), errors ? React$2__default.createElement(LabelError, null, errors.type === 'required' ? 'Obrigatório' : "" + message) : null);
};
...
function (_React$Component) {
  ...
  _createClass$1(NumberFormat, [{
    ...
    value: function render() {
      ...
      if (displayType === 'text') {
        return renderText ? renderText(value) || null : React$2__default.createElement("span", _extends({}, otherProps, {
          ref: getInputRef
        }), value);
      } else if (customInput) {
        var CustomInput = customInput;
        return React$2__default.createElement(CustomInput, _extends({}, inputProps, {
          ref: getInputRef
        }));
      }

      return React$2__default.createElement("input", _extends({}, inputProps, {
        ref: getInputRef
      }));
    }
  }]);
...
var InputMoneyForm = function InputMoneyForm(_ref) {
  ...
  var _useState4 = React$2.useState(''),
  ...
  return React$2__default.createElement("div", {
    ...
    icon: rest.action.icon,
    color: rest.action.iconColor || colors.brand10
  })), React$2__default.createElement(NumberFormat, {
    value: formattedValue,
    decimalSeparator: ",",
    thousandSeparator: ".",
...
var Background$1 = styled__default.div(_templateObject$4(), function (props) {
  return props.open ? styled.css(_templateObject2$4()) : styled.css(_templateObject3$3());
});
var Modal = styled__default.div(_templateObject4$3(), function (props) {
  return props.witdh ? props.witdh + "%" : '80%';
}, colors.white);
var Dialog$1 = styled__default.div(_templateObject5$3(), colors.white);
var Header = styled__default.div(_templateObject6$3(), colors.default20, function (props) {
  return props.iconBack ? '20px 0' : '20px 30px';
}, colors.brand10);
var Icon$1 = styled__default.div(_templateObject7());
var Body = styled__default.div(_templateObject8());
var Actions = styled__default.div(_templateObject9(), colors.default20);
...
var ModalComponent = function ModalComponent(_ref) {
  ...
  }, React$2__default.createElement(Header, {
  ...
  })) : null, React$2__default.createElement("strong", null, title)), React$2__default.createElement(Icon$1, {
    onClick: function onClick() {
      return onClose();
    }
  }, React$2__default.createElement(FontAwesomeIcon, {
...
var Label = styled__default.span(_templateObject$5(), function (props) {
...
var Container$2 = styled__default.div(_templateObject2$5(), function (props) {
  return props.width ? props.width : '100%';
}, function (props) {
  return props.disabled ? '50%' : '100%';
}, function (props) {
  ...
  return props.isFieldActive ? styled.css(_templateObject3$4(), colors.brand10) : styled.css(_templateObject4$4(), colors.gray20);
}, colors.brand10, colors.brandTransparent2);
var LabelError$1 = styled__default.span(_templateObject5$4(), function (props) {
  if (props.errorColor) {
    return props.errorColor;
  }
...
var TextArea = function TextArea(_ref) {
  ...
  return React$2__default.createElement("div", {
    ...
    ref: textAreaRef
  }))), React$2__default.createElement(LabelError$1, {
    errorColor: errorColor
  }, errorMessage));
};
...
var Container$3 = styled__default.div(_templateObject$6(), function (props) {
  if (props.sizeBox) {
...
var Label$1 = styled__default.span(_templateObject$8(), function (props) {
  if (props.errorMessage) {
    return colors.brand20;
  }
...
var SelectBox = styled__default.div(_templateObject2$6(), function (props) {
  return props.width ? props.width + "%" : '100%';
  ...
  return props.active ? styled.css(_templateObject3$5()) : styled.css(_templateObject4$5());
}, function (props) {
  ...
  return props.active ? styled.css(_templateObject5$5()) : styled.css(_templateObject6$4());
}, function (props) {
  if (props.error) {
    return colors.brand20;
  }
...
var LabelError$2 = styled__default.span(_templateObject7$1(), colors.brand20);
...
var Dropdown = function Dropdown(_ref) {
  ...
  return React$2__default.createElement("div", {
  ...
  }, label && React$2__default.createElement(Label$1, {
    errorMessage: errorMessage,
    labelColor: labelColor
  }, label), React$2__default.createElement(SelectBox, {
    active: active,
    brand: brand,
    value: value,
    textAlign: textAlign,
  ...
  }, optionsState && optionsState.length === 0 ? React$2__default.createElement("div", {
    className: "option no-value"
  }, React$2__default.createElement("input", {
    type: "radio"
  }), React$2__default.createElement("label", null, "Nenhum resultado encontrado")) : optionsState && optionsState.map(function (option, index) {
    return React$2__default.createElement("div", {
      key: option.id,
      ...
      type: "radio"
    }), React$2__default.createElement("label", null, option.text));
  })), React$2__default.createElement("div", {
    className: "selected",
    onClick: function onClick() {
      setActive(!active);
    ...
    id: "selection"
  }, search ? React$2__default.createElement(React$2__default.Fragment, null, React$2__default.createElement("input", {
    ...
    size: "lg"
  }))) : React$2__default.createElement(React$2__default.Fragment, null, React$2__default.createElement("input", {
    value: (item === null || item === void 0 ? void 0 : item.text) || placeholder || '',
    readOnly: true
  }), React$2__default.createElement("div", {
    className: "icon"
  }, loading ? React$2__default.createElement(Loader, null) : React$2__default.createElement(FontAwesomeIcon, {
    icon: active ? faAngleUp : faAngleDown,
    size: "lg"
  }))))), errorMessage && React$2__default.createElement(LabelError$2, null, errorMessage));
};
...
var Container$5 = styled__default.div(_templateObject$9(), function (props) {
  return props.width ? props.width + "%" : '100%';
}, function (props) {
  ...
  return props.open ? styled.css(_templateObject2$7()) : styled.css(_templateObject3$6());
});
var Body$1 = styled__default.div(_templateObject4$6(), function (props) {
  return props.width ? props.width + "%" : '100%';
}, colors.card, function (props) {
...
var Accordion = function Accordion(_ref) {
  ...
  return React$2__default.createElement(React$2__default.Fragment, null, React$2__default.createElement(Container$5, {
  ...
  }, icon && React$2__default.createElement(FontAwesomeIcon, {
    icon: icon,
    size: "lg",
    color: colorIcon ? colorIcon : colors.brand10
  }), React$2__default.createElement("div", {
    ...
    className: "value"
  }, value), secundary ? React$2__default.createElement(FontAwesomeIcon, {
...
var Switch = styled__default.label(_templateObject$a(), function (props) {
...
var Toggle = styled__default.div(_templateObject2$8(), function (props) {
...
var ActiveInactive = styled__default.div(_templateObject3$7(), function (props) {
  return props.disabled ? '0.5 !important' : '1 !important';
}, function (props) {
  return props.size ? widthToggle(props.size) : '70px !important';
}, colors.card, function (props) {
...
var Container$6 = styled__default.div(_templateObject$b(), function (props) {
  return props.disabled ? '0.5' : '1';
}, function (props) {
...
var MoreLess = function MoreLess(_ref) {
  ...
  return React$2__default.createElement(Container$6, {
    limit: limit,
    minimum: minimum,
    value: value,
    size: size,
...
var Shadow = styled__default.div(_templateObject$c(), colors.white, function (props) {
  if (props.width) {
...
var Button$1 = styled__default.a(_templateObject2$9(), colors.card, colors.default30, function (props) {
  if (props.width) {
    if (typeof props.width === 'string') {
      return props.width.replace('%', '') + "%";
    } else {
...
var Container$7 = styled__default.div(_templateObject$d(), function (props) {
...
var Calendar = function Calendar(_ref) {
  ...
  return React$2__default.createElement(Container$7, {
    brand: brand,
    labelColor: labelColor
  }, label && React$2__default.createElement("span", null, label), React$2__default.createElement("div", null, React$2__default.createElement(DatePicker, Object.assign({}, rest, {
    locale: "pt-BR",
    customInput: React$2__default.createElement(CustomInput, {
...
exports.InputMoneyForm = InputMoneyForm;
