...
`),e=>e.secundary||e.tertiary?"#FFFFFF":e.noBorder?"transparent":"#F7EA48",e=>e.size?(e=>{switch(e){case"mini":return"25px";case"tiny":return"30px";case"small":return"35px";case"medium":return"40px";case"large":return"45px";case"big":return"50px";case"huge":return"55px";case"massive":return"60px";default:return e}})(e.size):"40px",e=>e.width?e.width+"%":e.icon||e.tertiary?"":"100%",e=>e.rectangular?"10px":"30px",e=>e.secundary?"1px solid #9B4DEE":e.tertiary?"1px solid #ACACAC":"none",e=>e.icon||e.tertiary?"0 15px":"",e=>e.secundary?"rgba(155, 77, 238, 0.2)":e.backPurple?"#E0457B":e.noBorder?"transparent":e.tertiary?"rgba(211, 211, 211, 0.4)":"#9B4DEE",e=>e.secundary?"#9B4DEE":e.backPurple?"#FFFFFF":e.noBorder?e.colorText?e.colorText:"#9B4DEE":e.tertiary?"#707070":"#F7EA48"),ft=n.span(at||(at=dt`
    color: ${0};
    font-weight: ${0};
    font-size: ${0};
