...
`),(props=>props.size?`${widthSwitch(props.size)}px`:"50px"),(props=>props.disabled?"not-allowed ":"pointer"),(({disabled:disabled})=>disabled?.5:1),(props=>props.size?`${heightSwitch(props.size)}px !important`:"30px !important"),(props=>props.size?`${widthSwitch(props.size)}px !important`:"50px !important"),(props=>props.size?heightSwitch(props.size)/2+"px !important":"15px !important"),colors_card,(props=>props.size?heightSwitch(props.size)-2*(props.size,5)+"px !important":"20px !important"),(props=>props.size?heightSwitch(props.size)-2*(props.size,5)+"px !important":"20px !important"),colors_default10,colors_brandDark,(props=>props.size?widthSwitch(props.size)-(heightSwitch(props.size)-2*(props.size,5))-(props.size,5)+"px !important":"25px !important")),Toggle=styled_components__WEBPACK_IMPORTED_MODULE_3__.b.div(_t2$3||(_t2$3=_$3`
  font-family: MontSerrat !important;
  display: flex !important;
  flex-direction: row !important;
  opacity: ${0};
...
`),(props=>props.disabled?"0.5 !important":"1 !important"),(props=>props.disabled?"not-allowed !important":"pointer !important"),(props=>props.size?widthToggle(props.size):"4rem !important"),colors_card,(props=>props.size?(size=>{switch(size){case Sizes_xs:return"0.5rem !important";case Sizes_sm:return"0.625rem !important";default:return"0.6875rem !important";case Sizes_lg:return"0.8125rem !important";case Sizes_xl:return"0.9375rem !important"}})(props.size):"0.6875rem !important"),(props=>props.checked?`${colors_white} !important`:`${colors_brand10} !important`),(props=>props.checked?`${colors_gray20} !important`:`${colors_white} !important`),(props=>props.checked?`${colors_brand10} !important`:`${colors_white} !important`),(props=>props.checked?`${colors_white} !important`:`${colors_gray20} !important`)),ActiveInactive=styled_components__WEBPACK_IMPORTED_MODULE_3__.b.div(_t3$3||(_t3$3=_$3`
  font-family: MontSerrat !important;
  display: flex !important;
  flex-direction: row !important;
  opacity: ${0};
...
`),(props=>props.disabled?"0.5 !important":"1 !important"),(props=>props.disabled?"not-allowed !important":"pointer !important"),(props=>props.size?widthToggle(props.size):"4.375rem !important"),colors_card,(props=>props.size?(size=>{switch(size){case Sizes_xs:return"0.4375rem !important";case Sizes_sm:return"0.5625rem !important";default:return"0.625rem !important";case Sizes_lg:return"0.75rem !important";case Sizes_xl:return"0.875rem !important"}})(props.size):"0.625rem !important"),(props=>props.checked?`${colors_white} !important`:`${colors_brand20} !important`),(props=>props.checked?`${colors_gray20} !important`:`${colors_white} !important`),(props=>props.checked?`${colors_brandGreen} !important`:`${colors_white} !important`),(props=>props.checked?`${colors_white} !important`:`${colors_gray20} !important`)),TYPES_switch="switch",TYPES_toggle="toggle",TYPES_activeInactive="activeInactive",Selection=Object(react__WEBPACK_IMPORTED_MODULE_2__.forwardRef)((({type:type,checked:_checked=!1,onClick:onClick,onChange:onChange,size:size,disabled:disabled,className:className,style:style},ref)=>{const eventFunction=disabled?void 0:onClick||onChange;switch(type){case TYPES_switch:return function renderSwitch(){return Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)(Switch,Object.assign({className:className,style:style,size:size,ref:ref,disabled:disabled,role:"switch",onClick:eventFunction},{children:[Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("div",{className:_checked?"checked":""},void 0),Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("span",{"data-testid":"control",className:"control"},void 0)]}),void 0)}();case TYPES_toggle:return function renderToggle(){return Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)(Toggle,Object.assign({className:className,style:style,checked:_checked,ref:ref,size:size,disabled:disabled,role:"switch",onClick:eventFunction},{children:[Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("button",Object.assign({type:"button","data-testid":"btn-left",className:"btn left"},{children:Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("span",{children:"não"},void 0)}),void 0),Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("button",Object.assign({type:"button","data-testid":"btn-right",className:"btn right"},{children:Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("span",{children:"sim"},void 0)}),void 0)]}),void 0)}();case TYPES_activeInactive:return function renderActiveInactive(){return Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)(ActiveInactive,Object.assign({className:className,style:style,checked:_checked,ref:ref,size:size,disabled:disabled,role:"switch",onClick:eventFunction},{children:[Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("button",Object.assign({type:"button",className:"btn left"},{children:Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("span",{children:_checked?"desativar":"inativo"},void 0)}),void 0),Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("button",Object.assign({type:"button",className:"btn right"},{children:Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("span",{children:_checked?"ativo":"ativar"},void 0)}),void 0)]}),void 0)}();default:return null}}));Selection.displayName="Selection";let _t$2,_t2$2,_t3$2,_$2=t=>t;const ContainerPagination=styled_components__WEBPACK_IMPORTED_MODULE_3__.b.div(_t$2||(_t$2=_$2`
  display: flex;
  font-size: ${0};
