...
`),(props=>props.subtitle?"0.875rem":"1rem"),colors_gray20),Subtitle=styled_components__WEBPACK_IMPORTED_MODULE_3__.b.span(_t5$5||(_t5$5=_$f`
  color: ${0};
  font-size: 0.75rem;
`),colors_gray10),Value=styled_components__WEBPACK_IMPORTED_MODULE_3__.b.span(_t6$4||(_t6$4=_$f`
...
`),colors_brand10,colors_brand30,colors_brandTransparent2,colors_brand30),Icon=styled_components__WEBPACK_IMPORTED_MODULE_3__.b.div(_t5$4||(_t5$4=_$e`
  margin-right: ${0};
  margin-left: ${0};
`),(props=>"left"===props.iconPosition&&props.hasText?"10px":""),(props=>"right"===props.iconPosition&&props.hasText?"10px":"")),Amount=styled_components__WEBPACK_IMPORTED_MODULE_3__.b.div(_t6$3||(_t6$3=_$e`
  font-family: MontSerrat !important;
  background-color: ${0};
  width: 20px;
  height: 20px;
...
`),colors_brand30,colors_brand10),LoadingContainer=styled_components__WEBPACK_IMPORTED_MODULE_3__.b.div(_t7$2||(_t7$2=_$e`
  ...
  justify-content: center;
  align-items: center;
`));let _t$d,_t2$8,_$d=t=>t;const POSITIONS={center:"center",left:"flex-start",right:"flex-end"},widthLoader=size=>{switch(size){case"xs":return"1em";case"sm":return"1.75em";default:return"2.5em";case"lg":return"3.25em";case"xl":return"4em"}},widthBorder=size=>{switch(size){case"xs":return"2px";case"sm":return"3px";default:return"4px";case"lg":return"5px";case"xl":return"6px"}},Container$7=styled_components__WEBPACK_IMPORTED_MODULE_3__.b.div(_t$d||(_t$d=_$d`
  width: 100%;
  display: flex;
  justify-content: ${0};
...
`),(props=>props.open?Object(styled_components__WEBPACK_IMPORTED_MODULE_3__.a)(_t5$3||(_t5$3=_$9`
        ...
        `),colors_white,(()=>props.maxHeight||props.isLoading?"none":"auto"),(()=>props.maxHeight?"0":"20px"),(()=>props.maxHeight?"100%":"auto"),(()=>getMeasurement(props.maxHeight,"100%")),props.isLoading?"hidden":"auto",props.title?`calc(100% - ${props.sizeHeader}px)`:"100%"):Object(styled_components__WEBPACK_IMPORTED_MODULE_3__.a)(_t6$2||(_t6$2=_$9`
          transition: bottom 0.25s ease;
          bottom: -100%;
